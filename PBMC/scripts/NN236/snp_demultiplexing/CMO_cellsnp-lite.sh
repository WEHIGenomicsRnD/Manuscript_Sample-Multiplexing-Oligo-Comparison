...
#SBATCH --job-name=CMO_cellsnp-lite
#SBATCH -e CMO_cellSNP-%j.err
#SBATCH -o CMO_cellSNP-%j.out
...
CELLRANGERDIR="/stornext/Projects/score/2021_Sequencing_Runs/NN236/fastq/demux_fastq/R010_CMO_multi/outs/per_sample_outs/"
...
SampleArray=("VBDR1233_Rep-One_CMO301" "VBDR1233_Rep-Two_CMO302" "VBDR1206_Rep-One_CMO303" \
"VBDR1206_Rep-Two_CMO304" "VBDR1186_Rep-One_CMO305" "VBDR1186_Rep-Two_CMO306" \
"VBDR1216_Rep-One_CMO307" "VBDR1216_Rep-Two_CMO308")
...
/stornext/Projects/score/2021_Sequencing_Runs/NN236/fastq/demux_fastq/R010_CMO_multi/outs/multi/count/unassigned_alignments.bam \
             --outDir ${OUTDIR}/CMO \
             --regionsVCF ${REGIONSVCF} \
             --barcodeFile ${PROJECT_ROOT}/data/SCEs/NN236/cellBarcodes/cmoNonEmpty.txt \
             --nproc 20 \
             --minMAF 0.1 \
             --minCOUNT 20 \
             --gzip
