#!/bin/bash
#SBATCH --job-name=MULTI_souporcell
#SBATCH --partition=regular
#SBATCH --ntasks=1
#SBATCH --time=12:00:00
#SBATCH --cpus-per-task=18
#SBATCH --mem=240G
#SBATCH -e NXTspc-%j.err
#SBATCH -o NXTspc-%j.out
...
CELLRANGERDIR="/vast/scratch/users/brown.d/S000322/Cellranger_count_human/G000225_PDX_NXT/outs/";
...
singularity exec --bind $BIND_PATH,$BCPATH,$OUTPUT \
    ...
    -b ${BCPATH}MULTI-SeqCMO_wellBCs-hypen.csv \
    -f ${FASTA}genome.fa \
    -t 18 \
    -o ${OUTPUT}MULTIseqCMO \
    -k 4;
