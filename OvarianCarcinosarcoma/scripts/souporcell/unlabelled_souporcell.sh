...
BIND_PATH="/stornext/Projects/score"
CELLRANGERDIR="/stornext/Projects/score/GenomicsRnD/DB/S000331/cellranger_outs/G000225_PDX_UTD-hs/outs/";
...
singularity exec --bind $BIND_PATH,$BCPATH,$OUTPUT \
    ...
    -b ${BCPATH}Unlabelled_validBCs-hypen.csv \
    -f ${FASTA}genome.fa \
    -t 18 \
    -o ${OUTPUT}unlabelled \
    -k 4;
