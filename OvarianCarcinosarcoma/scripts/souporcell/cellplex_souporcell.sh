#!/bin/bash
#SBATCH --job-name=CellPlex_souporcell
#SBATCH --partition=regular
#SBATCH --ntasks=1
#SBATCH --time=12:00:00
#SBATCH --cpus-per-task=18
#SBATCH --mem=240G
#SBATCH -e CPspc-%j.err
#SBATCH -o CPspc-%j.out
...
CELLRANGERDIR="/vast/scratch/users/brown.d/S000322/Cellranger_count_human/G000225_PDX_CMO/outs/";
...
singularity exec --bind $BIND_PATH,$BCPATH,$OUTPUT \
    ...
    -b ${BCPATH}CellPlex_wellBCs-hypen.csv \
    -f ${FASTA}genome.fa \
    -t 18 \
    -o ${OUTPUT}cellplex \
    -k 4;
